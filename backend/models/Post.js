    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            await postRef.set({
                ...
                uuid: postRef.key,
                time: Date.now(),
                tagList: updateParams["tagList"] ? updateParams["tagList"] : ["dummy_tag"],
                commentList: ['dummy_comment'],
                followingList: [updateParams["author"]],
                isAnnouncement: updateParams["isAnnouncement"] ? updateParams["isAnnouncement"] : false,
                isPinned: updateParams["isPinned"] ? updateParams["isPinned"] : false,
                isAnonymous: updateParams["isAnonymous"] ? updateParams["isAnonymous"] : false,
                isPrivate: updateParams["isPrivate"] ? updateParams["isPrivate"] : false,
                isResolved: false,
                isInstructor: updateParams["isInstructor"] ? updateParams["isInstructor"] : false,
                score: 0,
...
deletePostById = async (uuid) => {
    ...
    await currentPost.getCommentList().forEach(async commentUUID => {
        await Comment.deleteCommentById(commentUUID, true);
    });
